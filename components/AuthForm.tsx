...
const AuthForm = ({ type, onSignUpSuccess }: { type: string; onSignUpSuccess?: () => void }) => {
    ...
    const onSubmit = async (data: z.infer<typeof
        ...
        try {
            ...
            if (type === "sign-up") {
                ...
                // Call the callback to fetch the logged in user in the parent component
                if (onSignUpSuccess) {
                    onSignUpSuccess();
                }
            }
            ...
            <header className="flex flex-col gap-5 md:gap-8">
                ...
                <div className="flex flex-col gap-1 md:gap-3">
                    <h1 className="text-24 lg:text-36 font-semibold text-gray-900">
                        {/* If user exists, link account. If not, check type. Then check if type is sign-in */}
